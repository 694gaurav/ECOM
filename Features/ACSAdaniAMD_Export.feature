...
Feature: ACS-Adani AMD Export feature 
 ...
 @AdaniAMDExport_01  @AdaniAMDExport_KaleGHA_CTO  
   Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale GHA1, Direct, Non-Bonded, Same CHA and check send manifest abd ACS receipt
     Given To verify whether the user is able to see Airport name as per selection from login page
 		 ...
 		 Then User Should create Shipment with quick ASI "<MAWBNo_01>" and "<CTO>" CTO-Kale GHA1, Direct, Non-Bonded, Same CHA
 		 Then User Should Search MAWB number1 "<MAWBNo_01>" for further process
  ...
  @AdaniAMDExport_02 @AdaniAMDExport_KaleGHA_CTO
   Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale_GHA1, Direct, Non-Bonded, Different CHA
     Given To verify whether the user is able to see Airport name as per selection from login page
 		 Then User should go to e-AWB tab for creating Quick ASI
 		 Then User should create shipment with quick ASI "<MAWBNo_02>" and "<CTO>" CTO-Kale_GHA1, Direct, Non-Bonded, Different CHA
 		 Then User Should Search MAWB number2 "<MAWBNo_02>" for further process
 		 Then User should process ASI submission 
 		 Then User Should verify carting order
    ...
    Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale_GHA1, Direct, Bonded, Same CHA
     Given To verify whether the user is able to see Airport name as per selection from login page
 		 Then User should go to e-AWB tab for creating Quick ASI
 		 Then User should create shipment with quick ASI "<MAWBNo_03>" and "<CTO>" CTO-Kale GHA1, Direct, Bonded, Same CHA
 		 Then User Should Search MAWB number3 "<MAWBNo_03>" for further process
 		 Then User should process ASI submission
 		 Then User Should verify carting order 
 		 Then User should add Shipping Bill with single SB for kale GHA1 CTO
 		 Then User should process TSP Payment without generate for kale GHA1 CTO
 		 Then User should generate vechile token
 		 Then User should be verify vechicle token no and AWB no
 		 Then User should goto track and trace tab for verify AdaniAMDExport_03 "<MAWBNo_03>"
  ...
  @AdaniAMDExport_04 @AdaniAMDExport_KaleGHA_CTO 
    Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale_GHA1, Direct, Bonded, Different CHA
     Given To verify whether the user is able to see Airport name as per selection from login page
 		 Then User should go to e-AWB tab for creating Quick ASI
 		 Then User should create shipment with quick ASI "<MAWBNo_04>" and "<CTO>" CTO-Kale GHA1, Direct, Bonded, Different CHA
 		 Then User Should Search MAWB number4 "<MAWBNo_04>" for further process
 		 Then User should process ASI submission
 		 Then User Should verify carting order
 		 Then User should logout application
 		 When I login with "Bonded Trucker Login" user given in "Login" sheet for Export module
 		 Then User should select bussiness line as customs broker
 		 Then User Should Search MAWB number4 "<MAWBNo_04>" for further process
 		 Then User should add Shipping Bill with multiple SB for kale GHA1 CTO
 		 Then User should process TSP Payment with generate token for kale GHA1 CTO
    ...
    Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale_GHA1, Consol, Non-Bonded, Same CHA
     Given To verify whether the user is able to see Airport name as per selection from login page
 		 Then User should go to e-AWB tab for creating Quick ASI
 		 Then User should create shipment with quick ASI "<MAWBNo_05>" and "<CTO>" CTO-Kale_GHA1, Consol, Non-Bonded, Same CHA
 		 Then User should click on Add HAWB button for adding multile houses
 		 Then User Should Search MAWB number5 "<MAWBNo_05>" for further process
 	...
 	##@AdaniAMDExport_06 @AdaniAMDExport_KaleGHA_CTO @AdaniAMDExport_KaleGHA_CTO_Rerun
    #Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale_GHA1, Consol, Non-Bonded, Different CHA
     #Given To verify whether the user is able to see Airport name as per selection from login page
 		 #Then User should go to e-AWB tab for creating Quick ASI
 		 #Then User should create shipment with quick ASI "<MAWBNo_06>" and "<CTO>" CTO-Kale_GHA1, Consol, Non-Bonded, Different CHA
 		 #Then User should click on Add HAWB button for adding multile houses
 		 #Then User Should Search MAWB number6 "<MAWBNo_06>" for further process
 		 #Then User should process ASI submission
 		 #Then User Should verify carting order 
 		 #Then User should logout application
 		 #When I login with "CB Login" user given in "Login" sheet for Export module
  ...
  @AdaniAMDExport_07 @AdaniAMDExport_KaleGHA_CTO 
    Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale_GHA1, Consol, Bonded, Same CHA
     Given To verify whether the user is able to see Airport name as per selection from login page
 		 Then User should go to e-AWB tab for creating Quick ASI
 		 Then User should create shipment with quick ASI "<MAWBNo_07>" and "<CTO>" CTO-Kale_GHA1, Consol, Bonded, Same CHA
 		 Then User should click on Add HAWB button for adding single house
 		 Then User Should Search MAWB number7 "<MAWBNo_07>" for further process
 		 Then User should process ASI submission
 		 Then User Should verify carting order 
 	...
 	##@AdaniAMDExport_08 @AdaniAMDExport_KaleGHA_CTO @AdaniAMDExport_KaleGHA_CTO_Rerun
    #Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale_GHA1, Consol, Bonded, Different CHA
     #Given To verify whether the user is able to see Airport name as per selection from login page
 		 #Then User should go to e-AWB tab for creating Quick ASI
 		 #Then User should create shipment with quick ASI "<MAWBNo_08>" and "<CTO>" CTO-Kale_GHA1, Consol, Bonded, Different CHA
 		 #Then User should click on Add HAWB button for adding single house
 		 #Then User Should Search MAWB number8 "<MAWBNo_08>" for further process
 		 #Then User should process ASI submission
 		 #Then User Should verify carting order 
 		 #Then User should logout application 
 		 #When I login with "Bonded Trucker Login" user given in "Login" sheet for Export module
 ...
 @AdaniAMDExport_09 @AdaniAMDExport_KaleGHA_CTO  
   Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale GHA2, Direct, Non-Bonded, Same and Single CHA
     Given To verify whether the user is able to see Airport name as per selection from login page
 		 Then User should go to e-AWB tab for creating Quick ASI
 		 Then User Should create Shipment with quick ASI "<MAWBNo_09>" and "<CTO>" CTO-Kale GHA2, Direct, Non-Bonded, Same and Single CHA
 		 Then User Should Search MAWB number09 "<MAWBNo_09>" for further process
 		 ...
 		 Then User should goto track and trace tab for verify AdaniAMDExport_09 "<MAWBNo_09>" 
  ...
  @AdaniAMDExport_10 @AdaniAMDExport_KaleGHA_CTO 
   Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale GHA2, Direct, Non-Bonded, Different and Single CHA
     Given To verify whether the user is able to see Airport name as per selection from login page
 		 Then User should go to e-AWB tab for creating Quick ASI
 		 Then User Should create Shipment with quick ASI "<MAWBNo_10>" and "<CTO>" CTO-Kale GHA2, Direct, Non-Bonded, Different and Single  CHA
  ...
  @AdaniAMDExport_11 @AdaniAMDExport_KaleGHA_CTO  
    Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale GHA2, Direct, Non-Bonded, Multiple CHA
     Given To verify whether the user is able to see Airport name as per selection from login page
 		 Then User should go to e-AWB tab for creating Quick ASI
 		 Then User Should create Shipment with quick ASI "<MAWBNo_11>" and "<CTO>" CTO-Kale GHA2, Direct, Non-Bonded, Multiple CHA
 		 ...
 		 Then User should be verify vechicle token no and AWB no using vechicle token milestone
 		 Then User should goto track and trace tab for verify AdaniAMDExport_11 "<MAWBNo_11>" 
 		 #Then User should logout application
 		 #When I login with "CB Login" user given in "Login" sheet for Export module
 		 #Then User should select bussiness line as customs broker
 		 #Then User Should Search MAWB number11 "<MAWBNo_11>" for further process
...
#multiple shipment single vechicle
  @AdaniAMDExport_12 @AdaniAMDExport_KaleGHA_CTO 
   Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale GHA2, Direct, Bonded, Same and Single CHA
     Given To verify whether the user is able to see Airport name as per selection from login page
 		 Then User should go to e-AWB tab for creating Quick ASI
 		 Then User Should create Shipment with quick ASI "<MAWBNo_12>" and "<CTO>" CTO-Kale GHA2, Direct, Bonded, Same and Single CHA
 		 Then User Should Search MAWB number12 "<MAWBNo_12>" for further process
 		 Then User should process ASI submission for kale GHA2 CTO
 		 Then User Should verify carting order
 		 Then User should add Shipping Bill with single SB and dimenssion for kale GHA2 CTO
 		 ...
 		 Then User should be verify vechicle token no and AWB no using vechicle token milestone
 		 Then User should goto track and trace tab for verify AdaniAMDExport_12 "<MAWBNo_12>"
 	...
 	@AdaniAMDExport_13 @AdaniAMDExport_KaleGHA_CTO 
   Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale GHA2, Direct, Bonded, Different and Single CHA
     Given To verify whether the user is able to see Airport name as per selection from login page
 		 Then User should go to e-AWB tab for creating Quick ASI
 		 Then User Should create Shipment with quick ASI "<MAWBNo_13>" and "<CTO>" CTO-Kale GHA2, Direct, Bonded, Different and Single CHA
 		 Then User Should Search MAWB number13 "<MAWBNo_13>" for further process
 		 Then User should process ASI submission for kale GHA2 CTO
 		 Then User Should verify carting order
 		 Then User should logout application
 		 When I login with "Bonded Trucker Login" user given in "Login" sheet for Export module
    ...
    Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale GHA2, Direct, Bonded, Multiple CHA
     Given To verify whether the user is able to see Airport name as per selection from login page
 		 Then User should go to e-AWB tab for creating Quick ASI
 		 Then User Should create Shipment with quick ASI "<MAWBNo_14>" and "<CTO>" CTO-Kale GHA2, Direct, Bonded, Multiple CHA
 		 ...
 		 Then User should be verify vechicle token no and AWB no using vechicle token milestone
 		 Then User should goto track and trace tab for verify AdaniAMDExport_14 "<MAWBNo_14>" 
 		 Then User should logout application
 		 When I login with "Bonded Trucker Login" user given in "Login" sheet for Export module
 		 #Then User should select bussiness line as customs broker
 		 #Then User Should Search MAWB number14 "<MAWBNo_14>" for further process
 ...
 @AdaniAMDExport_15 @AdaniAMDExport_KaleGHA_CTO 
   Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale GHA2, Consol, Non-Bonded, Same and Bulk CHA
     Given To verify whether the user is able to see Airport name as per selection from login page
 		 Then User should go to e-AWB tab for creating Quick ASI
 		 Then User Should create Shipment with quick ASI "<MAWBNo_15>" and "<CTO>" CTO-Kale GHA2, Consol, Non-Bonded, Same and Bulk CHA
 		 ...
 		 Then User should be verify vechicle token no and AWB no using vechicle token milestone
 		 Then User should goto track and trace tab for verify AdaniAMDExport_15 "<MAWBNo_15>" 
   ...
   Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale GHA2, Consol, Non-Bonded, Different and Bulk CHA
     Given To verify whether the user is able to see Airport name as per selection from login page
 		 Then User should go to e-AWB tab for creating Quick ASI
 		 Then User Should create Shipment with quick ASI "<MAWBNo_16>" and "<CTO>" CTO-Kale GHA2, Consol, Non-Bonded, Different and Bulk CHA
 ...
 @AdaniAMDExport_17 @AdaniAMDExport_KaleGHA_CTO 
   Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale GHA2, Consol, Non-Bonded, Multiple and Bulk CHA
     Given To verify whether the user is able to see Airport name as per selection from login page
 		 Then User should go to e-AWB tab for creating Quick ASI
 		 Then User Should create Shipment with quick ASI "<MAWBNo_17>" and "<CTO>" CTO-Kale GHA2, Consol, Non-Bonded, Multiple and Bulk CHA
 ...
 @AdaniAMDExport_18 @AdaniAMDExport_KaleGHA_CTO   
   Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale GHA2, Consol, Bonded, Same and Bulk CHA
     Given To verify whether the user is able to see Airport name as per selection from login page
 		 Then User should go to e-AWB tab for creating Quick ASI
 		 Then User Should create Shipment with quick ASI "<MAWBNo_18>" and "<CTO>" CTO-Kale GHA2, Consol, Bonded, Same and Bulk CHA
 		 Then User should Add HAWB With same Bulk CHA
 		 Then User Should Search MAWB number18 "<MAWBNo_18>" for further process
 		 Then User should process ASI submission for kale GHA2 CTO
 		 Then User Should verify carting order
 		 Then User should add Shipping Bill for bulk HAWB for kale GHA2 CTO
 		 Then User should process TSP Payment without Vechicle token for bulk HAWB for kale GHA2 CTO
  ...
  @AdaniAMDExport_19 @AdaniAMDExport_KaleGHA_CTO  @AdaniAMDExport_ASI_Rerun
   Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale GHA2, Consol, Bonded, Different and Bulk CHA
     Given To verify whether the user is able to see Airport name as per selection from login page
 		 Then User should go to e-AWB tab for creating Quick ASI
 		 Then User Should create Shipment with quick ASI "<MAWBNo_19>" and "<CTO>" CTO-Kale GHA2, Consol, Bonded, Different and Bulk CHA
 		 Then User should Add HAWB With Different Bulk CHA for Bonded
 		 ##Then User Should Search MAWB number19 "<MAWBNo_19>" for further process
 		 Then User should process ASI submission for kale GHA2 CTO
 		 Then User Should verify carting order
 		 Then User should logout application
 		 When I login with "Bonded Trucker Login" user given in "Login" sheet for Export module
 ...
 @AdaniAMDExport_20 @AdaniAMDExport_KaleGHA_CTO @AdaniAMDExport_ASI_Rerun
   Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - Kale GHA2, Consol, Bonded, Multiple and Bulk CHA
     Given To verify whether the user is able to see Airport name as per selection from login page
 		 Then User should go to e-AWB tab for creating Quick ASI
 		 Then User Should create Shipment with quick ASI "<MAWBNo_20>" and "<CTO>" CTO-Kale GHA2, Consol, Bonded, Multiple and Bulk CHA
 		 Then User should Add HAWB With Multiple Bulk CHA for Bonded
 		 Then User Should Search MAWB number20 "<MAWBNo_20>" for further process
 		 Then User should process ASI submission for kale GHA2 CTO
 		 Then User Should verify carting order
 		 Then User should add Shipping Bill for bulk HAWB for kale GHA2 CTO for Aeroprime
 		 Then User should process TSP Payment without Vechicle token for bulk HAWB for kale GHA2 CTO for Aeroprime
      ...
      #03
 		 ...
 		 #------------------------- Adani and CSC CTO -------------------------------
 		 # Need to create AWB no manually
 		 
 #@AdaniAMDExport_21 @AdaniAMDExport_29
   #Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO -Adani and CSC, Direct, Non-Bonded, Same CHA
     #Given To verify whether the user is able to see Airport name as per selection from login page
 		 #Then User should go to e-AWB tab for creating Quick ASI
 		 #Then User Should create Shipment with quick ASI "<MAWBNo>" "<CTO>" CTO-Adani and CSC, Direct, Non-Bonded, Same CHA
 		 #Then User Should Search "<MAWBNo>" for further process
 		 #Then User should process ASI submission
 		 #Then User should wait upto update ack file for carting order
 		 #Then User should add Shipping Bill with single SB for kale GHA1 CTO
 		 #Then User should wait upto update ack file for SB order
 		 #Then User should process TSP Payment with generate token for kale GHA1 CTO
 		 #Then User should goto track and trace tab for verify "<MAWBNo>"
 ...
 #@AdaniAMDExport_22 @AdaniAMDExport_37
   #Scenario Outline: ACS adani AMD Export End to End flow quick ASI Shipment Details: CTO - GSEC, Direct, Non-Bonded, Same and Single CHA
     #Given To verify whether the user is able to see Airport name as per selection from login page
 		 #Then User should go to e-AWB tab for creating Quick ASI
 		 #Then User Should create Shipment with quick ASI "<MAWBNo_37_22>" CTO-GSEC, Direct, Non-Bonded, Same and Single CHA
 		 #Then User Should Search MAWB number37_22 "<MAWBNo_37_22>" for further process
 		 #Then User should process ASI submission for kale GHA2 CTO
 		 #Then User should wait upto update ack file for carting order
 		 #Then User should add Shipping Bill with single SB and dimenssion for kale GHA2 CTO
 		 #Then User should wait upto update ack file for SB order
